Pro Evolution_Structures_CompareResolution
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
if f eq 1 then outputs=300
if f eq 10 then outputs=450
if f eq 100 then outputs=1000
print,f,nPlanets,outputs
 
  
if out eq 8 then dischargeImagesFolder='~/Dropbox/visualization_tools/images/CompareResolution/StructuresEvolution_NormalResolution'
if out eq 50 then dischargeImagesFolder='~/Dropbox/visualization_tools/images/CompareResolution/StructuresEvolution_HighResolution'
if out eq 51 then dischargeImagesFolder='~/Dropbox/visualization_tools/images/CompareResolution/StructuresEvolution_HigherResolution'
...
;Used arrays:
  ...
  InnerPlanetHill=dblarr(outputs+1)
...
;---------------------------------------------------------------------
	...
	print,xPlanet[i],yPlanet[i]
        print,Counter0Hill,Counter1Hill,Counter2Hill,Counter3Hill,Counter4Hill
        CounterInsideHill[i,n,0]=Counter0Hill
        CounterInsideHill[i,n,1]=Counter1Hill
        CounterInsideHill[i,n,2]=Counter2Hill
        CounterInsideHill[i,n,3]=Counter3Hill
        CounterInsideHill[i,n,4]=Counter4Hill
...
;---------------------------------------------------------------------        
       InnerPlanetHill[n]=Hillplanet[0]	
     endfor     
...
@Evolution_StructuresAreaInsideHill.pro
