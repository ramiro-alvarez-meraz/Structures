...
;  !P.MULTI = [0,1,1,0,0]
  plot,time,Structures_Inner(0,*),background=255,$                            
       color=0,ytitle='# Structures < 1 AU',yrange=[0,10],psym=1,$
  ...
  oplot,time,Structures_Inner(1,*),color=100,psym=1
  xyouts,390,500,'0.5 < !4s!X < 2.0',charsize=1.5,color=100,/device
  oplot,time,Structures_Inner(2,*),color=200,psym=1
  xyouts,390,470,'2.0 < !4s!X',charsize=1.5,color=200,/device
  write_png,strcompress(dischargeImagesFolder+'/Time_InnerStructures.png',$
