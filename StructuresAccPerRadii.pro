;window,13,xsize=600,ysize=600
     Set_plot,'z'
     Device,Set_resolution=[600,600],Set_Pixel_Depth=24
  plot,Structures(0,*),abs(AccTauRadPerBlock(0,*,0)),background=255,$                    
       color=0,ytitle='AccPerRadiiPerStructure ( M!L!9n!3!N/year)',yrange=[0.00000000001,0.000001],$
  ...
  for l=0,TauRanges-1 do begin
     for n=0,nPlanets do begin
        ...
        oplot,Structures(l,*),abs(AccTauRadPerBlock(l,*,n)),color=col,psym=simb
     endfor
  endfor
  ...
  write_png,strcompress(dischargeImagesFolder+$
                        '/Structures-AccPerRadiiPerStructure.png',/remove_all),tvrd(0,0,600,600,0,true=1)
